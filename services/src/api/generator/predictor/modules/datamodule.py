...
from ..datasets import preprocess_sequence, scale_target, split_dataset, tokenize_sequence
...
class SequenceTargetDataModule(L.LightningDataModule):
    ...
    def prepare_data(self) -> None:
        ...
        dataset = tokenize_sequence(dataset, self.tokenizer, self.sequence_col, self.tokenize_kwargs)
